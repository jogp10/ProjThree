...
class MyApp {
  ...
  initCameras() {
    ...
    const perspective1 = new THREE.PerspectiveCamera(75, aspect, 0.1, 100);
    perspective1.position.set(10, 10, 3);
    this.cameras["Perspective"] = perspective1;

    // Create a second basic perspective camera
    const perspective2 = new THREE.PerspectiveCamera(90, aspect, 0.1, 100);
    perspective2.position.set(4, 4, 4);
    this.cameras["Perspective 2"] = perspective2;

    // Create a cake perspective camera
    const cakeCamera = new THREE.PerspectiveCamera(50, aspect, 0.1, 100);
    cakeCamera.position.set(0, 3, -5);
    this.cameras["Cake"] = cakeCamera;

    // Create a corner basic perspective camera
    const corner = new THREE.PerspectiveCamera(60, aspect, 0.1, 100);
    corner.position.set(7, 1, -7);
    this.cameras["Corner"] = corner;
  ...
  updateCameraTarget() {
    if (this.activeCameraName === "Perspective 2") {
      this.controls.target = new THREE.Vector3(0, 0, 0);
    } else if (this.activeCameraName === "Cake") {
      this.controls.target = new THREE.Vector3(0, 3, 0);
    } else if (this.activeCameraName === "Corner") {
      this.controls.target = new THREE.Vector3(0, 0, 0);
    } else if (this.activeCameraName === "Left") {
      this.controls.target = new THREE.Vector3(0, 0, 0);
    } else if (this.activeCameraName === "Top") {
      this.controls.target = new THREE.Vector3(0, 0, 0);
    } else if (this.activeCameraName === "Front") {
      this.controls.target = new THREE.Vector3(0, 0, 0);
    } else if (this.activeCameraName === "Right") {
      this.controls.target = new THREE.Vector3(0, 0, 0);
    } else if (this.activeCameraName === "Back") {
      this.controls.target = new THREE.Vector3(0, 0, 0);
    }
  }
